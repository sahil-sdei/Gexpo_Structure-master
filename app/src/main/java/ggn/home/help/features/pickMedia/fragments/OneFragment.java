...
public class OneFragment extends Fragment {
    ...
    static GalleryFragment.FirstPageFragmentListener firstPageFragmentListener1;


    public static OneFragment newInstance(GalleryFragment.FirstPageFragmentListener firstPageFragmentListener) {
