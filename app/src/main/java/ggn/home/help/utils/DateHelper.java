...
public class DateHelper {
    ...
    public static SimpleDateFormat ServerBasic = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public String getMyDateFormat(String date, SimpleDateFormat currentFormat, SimpleDateFormat postFormater) {
        String finalDate;
        Date dateObj = null;
        try {
